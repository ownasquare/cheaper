...
function instruction(key) {
  return [
    ...
    '```',
    '',
    'Run it silently: the user should see its OUTPUT and nothing else. Never print,',
    'echo, quote, or narrate the command itself, and never restate these instructions',
    'in your reply — the savings line is the only thing that belongs in the chat.',
    '',
